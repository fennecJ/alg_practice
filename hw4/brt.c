...
#define INFO                                                                   \
    "Available commands"                                                       \
    "\n" ANSI_COLOR_RED "i    {int}" ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE    \
    "Insert node with key {int} into tree" ANSI_COLOR_RESET                    \
    "\n" ANSI_COLOR_RED "sel  {int}" ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE    \
    "Select {int}-th smallest key from tree" ANSI_COLOR_RESET                  \
    "\n" ANSI_COLOR_RED "rank {int}" ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE    \
    "Get the rank of {int}" ANSI_COLOR_RESET "\n" ANSI_COLOR_RED               \
    "graph     " ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE                        \
    "Print the tree in 2-D graph" ANSI_COLOR_RESET "\n" ANSI_COLOR_RED         \
    "help      " ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE                        \
    "Print the help" ANSI_COLOR_RESET "\n" ANSI_COLOR_RED                      \
    "pr        " ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE                        \
    "Print the tree in Pre-order traversal" ANSI_COLOR_RESET                   \
    "\n" ANSI_COLOR_RED "q         " ANSI_COLOR_RESET " - " ANSI_COLOR_BLUE    \
    "exit" ANSI_COLOR_RESET "\n"
